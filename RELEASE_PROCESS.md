# Release Process for Terraform Provider Bridge

## Overview

The `releaseBridgeProvider.sh` script automates the process of creating a new release for the terraform-provider-bridge.
...
```bash
NEW_VERSION=1.0.1 ./releaseBridgeProvider.sh -y
```
...
Latest version for terraform-provider-bridge: v1.0.0
-------------------------------------

Using provider: terraform-provider-bridge
Please enter the new version number (e.g., 1.2.3): 1.0.1

--- Starting release process for provider 'terraform-provider-bridge' and version v1.0.1 ---
...
--- Release process completed successfully for terraform-provider-bridge! ---
```
...
2. Verify the release appears on the [Releases page](https://github.com/jfrog/terraform-provider-bridge/releases)
